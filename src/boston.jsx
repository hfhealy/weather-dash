...
<div className="row d-flex justify-content-center align-items-center">
    ...
    <div className="card weather-box border shadow">
        ...
        <div className="d-flex flex-column text-center mt-3 mb-4">
            ...
            `${this.props.state.boston.main.temp.toFixed(0)}°F`}
            </h6>

            {this.props.dataFetched === false ? <span></span> : 
            <img src={`http://openweathermap.org/img/wn/${this.props.state.boston.weather[0].icon}@2x.png`} className="mx-auto" alt="weather-icon"/>}
